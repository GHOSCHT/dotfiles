...
Messages.save_wpa_conf = "Die Konfiguration von NetworkManager ist " \
    "fehlgeschlagen, aber es könnte stattdessen eine Konfigurationsdatei " \
    "für das Programm wpa_supplicant erstellt werden wenn Sie das " \
    "wünschen. Beachten Sie bitte, dass Ihr Passwort im Klartext in dieser " \
    "Datei steht."
...
Config.instname = "Leibniz-Rechenzentrum (LRZ) der Bayerischen " \
    "Akademie der Wissenschaften"
Config.profilename = "eduroam.mwn.de"
...
Config.user_realm = "eduroam.mwn.de"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.lrz.de']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymouscat@eduroam.mwn.de"
Config.tou = ""
